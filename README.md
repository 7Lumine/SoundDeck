...
1. GitHub Releases から配布ファイルをダウンロードします。
   - `SoundDeck-0.1.2-win-x64.zip`: 軽量版。別途 .NET 8 Desktop Runtime が必要です。
   - `SoundDeck-0.1.2-win-x64-self-contained.zip`: 自己完結版。.NET 8 Desktop Runtime なしで起動できます。
...
自己完結版は基本的に `SoundDeck.exe` だけで起動できますが、zipを展開してから実行してください。ファイルサイズは大きくなります。
...
軽量版を使っている場合は、.NET 8 Desktop Runtime をインストールしてください。

https://dotnet.microsoft.com/download/dotnet/8.0

.NET Runtime を入れたくない場合は、`self-contained` と名前に入っている自己完結版を使ってください。
